...
class DebugWindow(QWidget):
    """
    Debug window for displaying captured images and debug information.
    
    This window provides:
    - Multiple tabs for different types of debug images
    - Image display with metadata
    - Optional saving of debug images to disk
    - Automatic window positioning
    """
    
    window_closed = pyqtSignal()  # Signal emitted when window is closed
    ...
    def __init__(self) -> None:
        ...
        if debug_settings["save_screenshots"]:
            self.debug_dir.mkdir(parents=True, exist_ok=True)
            logger.debug(f"Debug screenshots directory created/verified: {self.debug_dir}")
        ...
        # Dictionary to track image tabs
        self.image_tabs = {}
