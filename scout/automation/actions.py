...
class ActionType(Enum):
    ...
    WAIT_FOR_PATTERN = auto()  # Wait for pattern match
...
@dataclass
class PatternWaitParams:
    """Parameters for pattern matching wait actions."""
    pattern_name: str  # Name of pattern to wait for
    position_name: Optional[str] = None  # Name of position to act on
    timeout: float = 30.0  # Timeout in seconds for conditions
    description: Optional[str] = None  # Optional description
    min_confidence: float = 0.8  # Minimum confidence for match
...
class AutomationAction:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'AutomationAction':
        ...
        params_class = {
            ...
            ActionType.WAIT_FOR_PATTERN: PatternWaitParams,
